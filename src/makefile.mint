...
test check: test_atlascoin FORCE
	./test_atlascoin
...
AtlasCoind: leveldb/libleveldb.a \
...
test_atlascoin: $(TESTOBJS) $(filter-out obj/init.o,$(OBJS:obj/%=obj/%))
	$(CXX) $(CFLAGS) -o $@ $(LIBPATHS) $^ $(LIBS) $(TESTLIBS)


clean:
	-rm -f AtlasCoind test_atlascoin
	-rm -f obj/*.o
	-rm -f obj-test/*.o
	-rm -f obj/*.P
	-rm -f obj-test/*.P
