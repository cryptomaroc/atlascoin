...

{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a AtlasCoin address (e.g. SGVQhkwomS9tEDhwakwZC9aVqFtzEF1ZVG)"));
#endif
...
void SendCoinsDialog::customizeUI()
{
    ...
    txtBanner = new QStealthBlueInfo(STEALTH_PAGE_ID_SEND_ATC, ui->frmBanner);
