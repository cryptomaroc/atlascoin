    ...
    : QLabel(parent)
{
    ...
    pages[k++] = pageSendATC = new QPageSendATC(this);
    pages[k++] = pageReceiveATC = new QPageAddrBook(QPageAddrBook::ForEditing, QPageAddrBook::ReceivingTab, this);
...
void QStealthMain::setModel(WalletModel *model)
{
    ...
    pageSendATC->setModel(model);
    pageReceiveATC->setModel(model->getAddressTableModel());
...
void QStealthMain::showOutOfSyncWarning(bool fShow)
{
    ...
    pageSendATC->showOutOfSyncWarning(fShow);
