...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "AtlasCoin.lnk";
}
...
{
    return GetAutostartDir() / "AtlasCoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("AtlasCoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  AtlasCoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("AtlasCoin-Qt"));
